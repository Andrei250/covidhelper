...
public class DisplayStoresActivity extends AppCompatActivity {
    ...
    private void DisplayShop() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new ShopAdapter(DisplayStoresActivity.this,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflate.inflate(R.menu.menu_search_store, menu);
        //SearchView
    ...
    private void searchData(String query) {
        db.getReference("Stores").orderByChild("email").equalTo(query).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                //when is succeedded
                items.clear();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                //when it fails
                Toast.makeText(DisplayStoresActivity.this,
